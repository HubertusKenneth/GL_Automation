...
WebUI.setText(findTestObject('Object Repository/UbahData/Page_ARB Banking System/textarea_Add_xui.UI.Input-INPUTd'), 'GLPM0003')

WebUI.click(findTestObject('Object Repository/UbahData/Page_ARB Banking System/span_Run'))

WebUI.setText(findTestObject('Object Repository/UbahData/Page_ARB Banking System/input_Pencarian_xui.UI.Input-INPUTf'), 
    'KEN TEST')

WebUI.sendKeys(findTestObject('Object Repository/UbahData/Page_ARB Banking System/input_Pencarian_xui.UI.Input-INPUTf'), 
    Keys.chord(Keys.ENTER))
...
TestObject inputInduk = new TestObject("inputInduk")
inputInduk.addProperty("xpath", ConditionType.EQUALS, "//div[contains(@class,'xui-list-item')]//span[normalize-space(text())='10000000 - AKTIVA LANCAR']")

WebUI.waitForElementClickable(inputInduk, 10)
WebUI.click(inputInduk)
WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/UbahData/Page_ARB Banking System/span_Simpan'))

WebUI.click(findTestObject('Object Repository/UbahData/Page_ARB Banking System/span_Ya'))

WebUI.click(findTestObject('Object Repository/UbahData/Page_ARB Banking System/span_O K_1'))
