...
WebUI.setText(findTestObject('Object Repository/PersetujuanData/Page_ARB Banking System/input_Pencarian_xui.UI.Input-INPUTq'), 
    'KEN TEST')

WebUI.sendKeys(findTestObject('Object Repository/PersetujuanData/Page_ARB Banking System/input_Pencarian_xui.UI.Input-INPUTq'), 
    Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Object Repository/PersetujuanData/Page_ARB Banking System/span_1 (2)'))

WebUI.setText(findTestObject('Object Repository/PersetujuanData/Page_ARB Banking System/textarea_Komentar_xui.UI.Input-INPUTs'), 
    'TESTING')

WebUI.click(findTestObject('Object Repository/PersetujuanData/Page_ARB Banking System/span_Simpan Komentar (1)'))

WebUI.click(findTestObject('Object Repository/PersetujuanData/Page_ARB Banking System/span_Ya (2)'))

WebUI.click(findTestObject('Object Repository/PersetujuanData/Page_ARB Banking System/span_O K_1'))
