...
WebUI.sendKeys(findTestObject('Object Repository/TambahDataBaru/Page_ARB Banking System/input_Keterangan_xui.UI.Input-INPUTm'), 
    Keys.chord(Keys.ENTER))
...
//WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS, "//*[@id='xui.UI.Label-ICON:aa:']"))
