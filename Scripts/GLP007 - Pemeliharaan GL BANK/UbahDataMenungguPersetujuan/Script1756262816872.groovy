...
WebUI.setText(findTestObject('Object Repository/UbahData/Page_ARB Banking System/textarea_Add_xui.UI.Input-INPUTd'), 'GLPM0025')

WebUI.click(findTestObject('Object Repository/UbahData/Page_ARB Banking System/span_Run'))

WebUI.setText(new TestObject().addProperty('xpath', ConditionType.EQUALS, "//*[@id='xui.UI.Input-INPUT:g:']"),'KEN TEST')
